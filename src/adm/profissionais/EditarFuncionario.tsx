...
export default function EditarProfissional() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const response = await axios.get(`/administrador/profissional/api/${id}/`);
        setFormData({
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      await axios.put(`/administrador/profissional/api/${id}/`, formData);
      navigate("/painel/admin/profissionais");
    } catch (err: any) {
